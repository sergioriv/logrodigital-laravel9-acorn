 ...
 */
 ...
 class DatatableHeadquarters {
    ...
    _createInstance() {
        const _this = this;
        this._datatable = jQuery("#datatable_headquarters").DataTable({
            scrollX: true,
            ajax: "/headquarters.json",
            ...
            columnDefs: [
                // Adding Name content as an anchor with a target #
                {
                    ...
                    render: function (data, type, row, meta) {
                        return (
                            '<a class="list-item-heading body" href="headquarters/' + row.id + '/edit">' + data + "</a>"
                        );
                    },
                },
                {
