                            ...
                            <div class="card-body row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <text class="form-control">{{ $orientation->expeditionCity?->department->name .' | '. $orientation->expeditionCity?->name }}</text>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <x-label>{{ __('birth city') }}</x-label>
                                        <text class="form-control">{{ $orientation->birthCity?->department->name .' | '. $orientation->birthCity?->name }}</text>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <text class="form-control">{{ $orientation->residenceCity?->department->name .' | '. $orientation->residenceCity?->name }}</text>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                            ...
                            <div class="card-body row g-3">
                                ...
                                @if ($orientation->file_possession_certificate)
                                    ...
                                    <div class="col-md-3">
                                        <div class="position-relative form-group">
                                            <x-label>{{ __('date') }}</x-label>
                                            <text class="form-control">{{ $orientation->date_possession_certificate }}</text>
                                        </div>
                                    </div>
                                    <div class="col-md-3 d-flex align-items-end justify-content-center">
