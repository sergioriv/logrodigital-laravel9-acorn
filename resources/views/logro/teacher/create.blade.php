                        ...
                        <div class="card mb-5">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="mb-3 w-100 position-relative form-group">
                                            <x-label>{{ __('type of appointment') }}</x-label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 w-100 position-relative form-group">
                                            <x-label>{{ __('type of administrative act') }}</x-label>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 position-relative form-group">
                                            ...
                                            <x-input :value="old('date_appointment')" logro="datePicker" name="date_appointment" />
                                        </div>
                                    </div>
                                </div>
                            </div>
