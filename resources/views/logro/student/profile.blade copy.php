                ...
                <section class="scroll-section" id="title">
                    <div class="page-title-container">
                        <h1 class="mb-0 pb-0 display-4">
                            {{ __('Student') . ' | ' . $student->getNames() . ' ' . $student->getLastNames() }}
                        </h1>
                    </div>
                </section>
                <!-- Title End -->
                ...
                <section class="scroll-section">
                    <div class="row gx-4 gy-5">
                        ...
                        <div class="col-12 col-xl-3">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center flex-column">
                                        <div class="mb-5 d-flex align-items-center flex-column">
                                            ...
                                            @if (null !== $student->birthdate)
                                                <span
                                                    class="mb-2 text-muted">{{ $student->age() . ' ' . __('years') }}</span>
                                            @endif
                            ...
                            <!-- Biography End -->
                            <div class="card card-color-background mb-3">
                                <div class="card-body p-lr-0">
                                    <div class="d-grid gap-2">
                                        <a class="btn btn-info" href="{{ route('students.matriculate', $student) }}" >{{ __('Matriculate') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <div class="h-100">
                                                            <div class="text-center d-flex flex-column">
                                                                <span>
                                                                    ...
                                                                    @else
                                                                        <i
                                                                            class="icon bi-file-earmark icon-70 text-muted"></i>
                                                                    @endif
