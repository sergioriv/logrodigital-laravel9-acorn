...
<script>
    jQuery('#select2Headquarters').select2({minimumResultsForSearch: 5, placeholder: ''});
    jQuery('#select2StudyTime').select2({minimumResultsForSearch: 5, placeholder: ''});
    jQuery('#select2StudyYear').select2({minimumResultsForSearch: 5, placeholder: ''});
    jQuery('#select2Teacher').select2({minimumResultsForSearch: true, placeholder: ''});
</script>
@endsection
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <select id="select2Headquarters" name="headquarters" required>
                                            ...
                                            <option value="{{ $hq->id }}"
                                                @if ($group->headquarters_id !== null) @selected(old('headquarters', $group->headquarters_id) == $hq->id) @endif>
                                                {{ $hq->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="select2StudyTime" name="study_time" required>
                                            ...
                                            <option value="{{ $st->id }}"
                                                @if ($group->study_time_id !== null) @selected(old('study_time', $group->study_time_id) == $st->id) @endif>
                                                {{ $st->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row g-3 mt-1">
                                    <div class="col-md-6">
                                        ...
                                        <select id="select2StudyYear" name="study_year" required>
                                            ...
                                            <option value="{{ $sy->id }}"
                                                @if ($group->study_year_id !== null) @selected(old('study_year', $group->study_year_id) == $sy->id) @endif>
                                                {{ $sy->name }}
                                            </option>
                                            @endforeach
                                        </select>
