...
@section('js_page')
    ...
    <script>
        jQuery("#studentsTransferCheckAll").click(function() {
            if ($(this).is(':checked')) {
                $("[logro='studentCheck']").prop('checked', 'checked');
                $("#saveStudentsTransfer").prop('disabled', false);
            } else {
                $("[logro='studentCheck']").prop('checked', '');
                $("#saveStudentsTransfer").prop('disabled', true);
            }
        });
        ...
        <div class="row">
            <div class="col">
                ...
                <section class="scroll-section">
                    ...
                    <form method="POST" action="{{ route('group.transfer-students.select-students', $group) }}" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <x-button type="submit" id="saveStudentsTransfer" disabled class="btn-primary">
                            {{ __('Continue') }}</x-button>
