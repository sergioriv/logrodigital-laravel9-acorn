        ...
        <div class="row">
            <div class="col">
                ...
                <section class="page-title-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-7">
                            <h1 class="mb-1 pb-0 display-4" id="title">{{ $title }} | {{ __('Edit avatar') }}</h1>
                        </div>
                        <!-- Title End -->
                    </div>
                </section>
                ...
                <section class="scroll-section">
                    <form method="post" action="{{ route('student.avatar.update', ['student' => $student->id]) }}"
                        ...
                        <div class="card mb-5">
                            <div class="card-body text-center">
                                <div class='position-relative d-inline-block' id="imageProfile">
                                    @php
                                        if (!is_null($student->user->avatar) && file_exists($student->user->avatar)) $avatar = config('app.url') .'/'. $student->user->avatar;
                                    ...
                                    <input name="file_upload" id="avatar" class="file-upload d-none" type="file" accept="image/jpg, image/jpeg, image/png, image/webp" />
                                </div>
                            </div>
                        </div>
