 ...
 */
 ...
 class DatatableTeachers {
    ...
    _createInstance() {
        const _this = this;
        this._datatable = jQuery("#datatable_teachers").DataTable({
            scrollX: true,
            ajax: "/teachers.json",
            ...
            columnDefs: [
                // Adding Name content as an anchor with a target #
                {
                    ...
                    render: function (data, type, row, meta) {
                        return (
                            '<a class="list-item-heading body" href="teachers/' + row.id + '">' + data + ' ' + row.second_name + "</a>"
                        );
                    },
                },
